  ...
  <b-collapse tag="nav" class="navbar-collapse" id="navbar">
    <ul class="navbar-nav navbar-nav-scroll ms-auto" style="--ar-scroll-height: 520px">
      <nav class="nav justify-content-center justify-content-md-start pb-sm-2 pb-md-0 mb-4 mb-md-0 ms-md-n3">
        <router-link class="nav-link py-1 px-0 mx-3" to="/use-cases">{{ $t('nav.useCases') }}</router-link>
        <router-link class="nav-link py-1 px-0 mx-3" to="/blog">{{ $t('nav.blog') }}</router-link>
        <router-link class="nav-link py-1 px-0 mx-3" to="/projects">{{ $t('nav.projects') }}</router-link>
        <router-link class="nav-link py-1 px-0 mx-3" to="/contact">{{ $t('nav.contact') }}</router-link>
      </nav>
