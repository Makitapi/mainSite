<template>
  <section class="overflow-hidden pt-2 pt-sm-3 pt-md-4 pt-lg-3 pb-1 pb-sm-3 pb-md-4 pb-lg-5">
    <b-container class="position-relative py-5 my-lg-3 my-xl-4 my-xxl-5">
      ...
      <b-row class="justify-content-center justify-content-lg-start position-relative z-2">
        <b-col sm="10" md="8" lg="5" xl="4" class="text-center text-lg-start" data-aos="fade-up" data-aos-duration="850" data-aos-offset="120" data-disable-parallax-down="lg">
      ...
      <div class="d-flex position-relative z-2 mb-3">
        <div class="flex-xxl-shrink-0 position-relative z-2" style="max-width: 540px; margin-top: 26%; margin-right: -9.6%" data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" data-disable-parallax-down="lg">
          <img class="rounded-3 mt-n5 mt-lg-0 d-block d-dark-mode-none" :src="intro1Light" alt="Page" style="box-shadow: 1.875rem 0.625rem 5rem rgba(65, 81, 98, 0.2)" />
          <img class="border rounded-3 mt-n5 mt-lg-0 d-none d-dark-mode-block" :src="intro1Dark" alt="Page" style="box-shadow: 1.875rem 0.625rem 5rem rgba(0, 0, 0, 0.2)" />
        </div>
        <div class="flex-xxl-shrink-0 position-relative z-1" style="max-width: 481px; margin-top: 17.6%; margin-right: -8.5%" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200" data-disable-parallax-down="lg">
          <img class="rounded-3 mt-n5 mt-lg-0 d-block d-dark-mode-none" :src="intro2Light" alt="Page" style="box-shadow: 1.875rem 0.625rem 5rem rgba(65, 81, 98, 0.2)" />
          <img class="border rounded-3 mt-n5 mt-lg-0 d-none d-dark-mode-block" :src="intro2Dark" alt="Page" style="box-shadow: 1.875rem 0.625rem 5rem rgba(0, 0, 0, 0.2)" />
        </div>
        <div class="flex-xxl-shrink-0" style="max-width: 510px" data-aos="fade-up" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="lg">
          <img class="rounded-3 d-block d-dark-mode-none" :src="intro3Light" alt="Page" style="box-shadow: 1.875rem 0.625rem 5rem rgba(65, 81, 98, 0.2)" />
          <img class="border rounded-3 d-none d-dark-mode-block" :src="intro3Dark" alt="Page" style="box-shadow: 1.875rem 0.625rem 5rem rgba(0, 0, 0, 0.2)" />
        </div>
      </div>
    </b-container>
  </section>
...
import intro1Light from '@/assets/img/landing/intro/pages/01-light.jpg'
import intro1Dark from '@/assets/img/landing/intro/pages/01-dark.jpg'

import intro2Light from '@/assets/img/landing/intro/pages/02-light.jpg'
import intro2Dark from '@/assets/img/landing/intro/pages/02-dark.jpg'

import intro3Light from '@/assets/img/landing/intro/pages/03-light.jpg'
import intro3Dark from '@/assets/img/landing/intro/pages/03-dark.jpg'
</script>
