  ...
  <b-container>
    <div class="bg-dark position-relative rounded-5 overflow-hidden px-4 pt-1 pb-2 py-sm-4 py-lg-5">
      ...
      <div class="position-relative z-3 text-center py-5 my-xl-3 mx-auto" style="max-width: 565px" data-bs-theme="dark">
        ...
        <b-form class="subscription-form validate mx-auto" action="https://studio.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;amp;id=29ca296126" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate style="max-width: 500px">
          <div class="input-group">
            <span class="input-group-text"><i class="ai-mail"></i></span>
            <b-form-input type="email" name="EMAIL" placeholder="Enter your email" required id="subscr-email" />
            <b-button variant="primary" type="submit" name="subscribe">Subscribe*</b-button>
          </div>
