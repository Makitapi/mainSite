...
export const tags: string[] = ['Inspiration', 'Travel', 'Books']

export const socialICon: string[] = ['Instagram', 'Facebook', 'Telegram', 'X']

export const trendingPost: TrendingPostType[] = [
  {
...
export const topics = ['Reading', 'Inspiration', 'Travel', 'Psychology']
