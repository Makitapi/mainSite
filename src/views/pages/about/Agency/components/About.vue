<template>
  <b-container class="position-relative z-3" style="margin-top: -135px">
    <div class="rounded-5 overflow-hidden">
      <Jarallax custom-class="jarallax ratio ratio-16x9" :options="{ speed: 0.6 }">
        <div class="jarallax-img" :style="`background-image: url(${parallaxImg});`"></div>
      </Jarallax>
    </div>
    <b-row class="pt-5 mt-n2 mt-sm-0 mt-md-2 mt-lg-4 mt-xl-5">
      <b-col md="6" lg="5">
        <div class="fs-sm text-uppercase mb-3">What we do</div>
        <h2 class="display-6">We are a team who create marketing strategies</h2>
      </b-col>
      <b-col md="6" xl="5" class="offset-lg-1 offset-xl-2 pt-1 pt-sm-2 pt-md-5">
...
import parallaxImg from '@/assets/img/about/agency/parallax-image.jpg'
</script>
