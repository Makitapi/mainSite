<template>
  <section class="position-relative pt-5 mt-2 mt-xl-4 mt-xxl-5">
    ...
    <b-container class="py-3 pt-sm-4 pt-lg-5 mt-xl-2 mt-xxl-3 mb-3 mb-lg-4">
    ...
    <b-container class="container-start position-relative z-2 pe-0">
      <LightGallery custom-class="gallery">
        <Swiper
          ...
          wrapperClass="align-items-end"
        >
          <SwiperSlide v-for="(item, idx) in gallery" :key="idx" class="w-auto">
            <a class="d-block gallery-item card-hover zoom-effect" :href="item.image" :style="`max-width: ${item.width}px;`">
...
import { gallery } from '@/views/pages/about/Agency/data'
</script>
