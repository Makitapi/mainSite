<template>
  <main class="page-wrapper py-5 vh-100">
    <b-container class="d-flex flex-column justify-content-center align-items-center h-100 text-center pb-2 py-sm-3 py-md-4 py-lg-5">
      <router-link class="navbar-brand text-dark p-0 m-0 mb-5" :to="{ name: 'landing' }">
      ...
      <b-form class="input-group mx-auto" style="max-width: 480px">
...
import lineImg from '@/assets/img/coming/lines.png'
...
onMounted(() => {
  document.body.style.backgroundImage = `url('${lineImg}')`
