  ...
  <main class="page-wrapper">
    <div class="d-lg-flex position-relative h-100">
      ...
      <div class="d-flex d-lg-none justify-content-center pt-4 px-3 mx-auto" style="max-width: 420px">
        <router-link class="navbar-brand text-dark p-0 m-0" :to="{ name: 'landing' }">
      ...
      <div class="w-sm-75 w-lg-100 p-4 overflow-hidden mx-auto mx-lg-0 order-lg-2" style="max-width: 1047px">
        <div class="p-sm-3 h-100">
          <div class="position-relative h-100">
            <div class="position-absolute top-0 end-0 h-100 bg-primary rounded-5 d-none d-lg-block" style="width: 93.9%"></div>
            <div class="position-absolute top-0 end-0 h-100 bg-primary rounded-4 d-lg-none" style="width: 93.9%"></div>
            <Parallax id="parallax1" custom-class="parallax h-100 z-2 overflow-hidden">
              <div class="parallax-layer d-flex align-items-end mb-n2 mb-lg-0" style="margin-top: 4.4%" data-depth="0.1">
                <img :src="girlImg" alt="Girl" />
              </div>
            </Parallax>
            <Parallax id="parallax2" custom-class="parallax position-absolute top-0 start-0 w-100 h-100 z-2">
              <div class="parallax-layer d-flex align-items-end" style="padding-right: 75.6%; padding-bottom: 70%" data-depth="-0.1">
                <svg class="text-warning" xmlns="http://www.w3.org/2000/svg" width="239" height="233" viewBox="0 0 239 233" fill="none" xmlns:v="https://vecta.io/nano">
                  <g class="C">
                    <g stroke="currentColor" stroke-width="1.923" class="B">
                      <path
                        d="M87.071 128.678s-2.681 19.31 1.872 35.431c5.767 20.454 27.526 48.523 31.467 47.495s-2.161-14.445-2.196-25.458c-.069-18.236 8.251-24.568 8.251-24.568l-39.394-32.9zM234.248 231.78c-11.856-4.287-14.572-17.53-16.71-27.584-1.236-5.778-2.357-11.729-6.055-17.022a26.14 26.14 0 0 0-6.714-6.622c-.844-.566-6.668-4.16-7.754-3.027 2.623-2.727 11.232 2.947 14.237 5.119 3.258 2.346 8.955 7.5 10.157 11.417.867-3.859-2.438-11.29-4.148-15.115-2.647-5.905-6.691-13.74-10.944-18.975-7.419-9.152-17.808-14.826-28.185-15.612-2.947-.22-6.148.358-8.967.867-25.539 4.599-35.269 38.493-11.741 60.126 6.286 5.778 13.832 9.302 21.632 10.446 7.385 1.075 17.831.451 22.049 9.418 1.341-5.177-5.986-15.785-11.255-19.541-2.381-1.699-5.131-3.316-7.812-4.079-2.704-.763-4.703-1.098-6.922-1.468 2.577-.658 1.283-.485 4.322-.693 2.323-.15 6.148.936 9.106 1.895 5.142 1.676 14.087 8.817 17.484 13.151 7.5 9.614 16.098 19.09 28.22 17.299z"
                      />
                      ...
                      <path
                        d="M9.334 7.859c9.823.381 22.708 2.6 36.69 7.095l-3.536 6.067c-6.448 11.048-15.381 20.432-26.105 27.4l-6.887 4.472C4.48 39.084 1.776 26.291 1.025 16.492.655 11.708 4.538 7.675 9.334 7.86zM123.31 126.077l.023-.023c2.577-2.681 8.159-.751 13.336 4.23s35.373 35.2 31.64 39.071l-.011.011-.012.012c-3.721 3.871-35.061-25.158-40.238-30.138s-7.315-10.482-4.738-13.163zM53.269 58.475c7.234-7.512 19.194-7.743 26.706-.509s7.743 19.195.508 26.706-19.195 7.742-26.706.508-7.742-19.195-.508-26.706z"
                      />
                    </g>
                    <path d="M11.795 1.007c9.823.381 22.708 2.6 36.69 7.095l-3.536 6.067c-6.448 11.048-15.381 20.431-26.105 27.4l-6.887 4.472c-5.016-13.81-7.72-26.602-8.471-36.402a8.01 8.01 0 0 1 8.309-8.632zm113.977 118.218l.023-.023c2.577-2.681 8.158-.751 13.335 4.229 3.467 3.34 18.143 17.982 26.348 28.463 4.045 5.165 6.518 9.326 5.293 10.608l-.012.012-.011.011c-1.248 1.295-5.617-1.109-11.06-5.073-10.77-7.835-25.746-21.76-29.178-25.065-5.189-4.98-7.327-10.481-4.738-13.162z" class="D E B" />
                    <use xlink:href="#B" />
                  </g>
                  <use xlink:href="#B" class="B D E" />
                  <use xlink:href="#C" class="C" />
                  <use xlink:href="#C" stroke-linecap="round" stroke-linejoin="round" class="B D E" />
                  <path d="M165.466 151.443l14.284-14.838-5.998-5.767" class="C" />
                  <path d="M165.466 151.443l14.284-14.838-5.998-5.767" class="B D E" />
                  <path d="M139.627 166.293l5.986 5.766 14.064-14.607" class="C" />
                  <path d="M139.627 166.293l5.986 5.766 14.064-14.607" class="B D E" />
                  ...
                  <g class="B D E">
                    <use xlink:href="#F" />
                    <path d="M55.73 51.622c7.234-7.511 19.194-7.742 26.706-.508s7.742 19.195.508 26.706-19.194 7.743-26.706.508-7.743-19.195-.508-26.706z" class="C" />
                  </g>
                  <defs>
                    <path id="B" d="M88.839 139.945c.243 5.512.948 11.614 2.554 17.311 5.766 20.454 27.526 48.523 31.467 47.495s-2.161-14.445-2.196-25.458c-.023-7.627 1.41-13.162 3.097-17.033" />
                    <path
                      id="C"
                    ...
                    />
                    <path id="D" d="M145.509 81.726c5.524.439 11.649 1.375 17.334 3.213 20.223 6.529 47.449 29.341 46.282 33.235-1.167 3.906-14.352-2.704-25.365-3.155-6.067-.254-10.851.474-14.538 1.561" />
                    <path id="E" d="M153.448 152.761l-15.6 16.201c-2.023-1.028-6.888-3.189-13.972-6.945-8.724-4.634-20.8-11.695-35.026-22.084-11.256-8.228-23.852-18.535-37.187-31.374-19.322-18.605-32.149-41.717-39.706-62.541" />
                    <path id="F" d="M48.486 8.09c21.09 6.772 44.664 18.698 63.998 37.314 43.855 42.226 60.068 77.494 63.616 83.827l-15.613 16.225" />
                  </defs>
                </svg>
              </div>
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 59.35% 70.4% 30.4%" data-depth="0.2">
                <svg class="text-white" width="100" height="90" viewBox="0 0 100 90" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 11.58% 89.64% 81.28%" data-depth="-0.15">
                <svg class="text-warning" width="69" height="55" viewBox="0 0 69 55" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 70.94% 54.29% 24.4%" data-depth="-0.35">
                <svg class="text-warning" width="45" height="45" viewBox="0 0 45 45" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 69.6% 92.57% 26.37%" data-depth="-0.25">
                <svg class="text-white" width="39" height="38" viewBox="0 0 39 38" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 17.48% 74.58% 79.94%" data-depth="0.2">
                <div class="ratio ratio-1x1 border border-white border-2 rounded-circle"></div>
              </div>
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 87.38% 66.96% 11.27%" data-depth="0.15">
                <div class="ratio ratio-1x1 bg-white rounded-circle"></div>
              </div>
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 46.23% 91.84% 52.43%" data-depth="0.35">
                <div class="ratio ratio-1x1 bg-warning rounded-circle"></div>
              </div>
              <div class="parallax-layer d-flex align-items-end" style="padding: 0 3.6% 56.17% 94.93%" data-depth="0.4">
                <div class="ratio ratio-1x1 bg-warning rounded-circle"></div>
              </div>
            </Parallax>
          </div>
      ...
      <div class="d-flex flex-column align-items-center w-lg-50 px-3 px-sm-4 px-xl-5 pt-lg-5 order-lg-1">
        ...
        <div class="w-100 text-center text-lg-start mt-auto pt-lg-5 pb-5" style="max-width: 420px">
          <h1 class="display-3 mb-4">We are coming soon</h1>
          <p class="fs-lg pb-3 mb-4 mb-xl-5">We can't wait to unveil what we've been working on, and we appreciate your patience. Thanks for being a part of our journey!</p>

          <!-- Countdown -->
          <div class="countdown d-flex flex-wrap justify-content-center justify-content-lg-start pb-3 mb-4 mb-xl-5" data-countdown-date="01/01/2026 12:00:00">
          ...
          <b-form class="input-group">
            <b-form-input type="email" placeholder="Enter your email" required />
            <b-button variant="primary" type="submit">Notify me</b-button>
          </b-form>
        </div>
...
import girlImg from '@/assets/img/coming/girl.png'

const today = new Date()

function getFutureDate(date = new Date(), daysToAdd = 5) {
  const futureDate = new Date(date.getTime())
  futureDate.setDate(date.getDate() + daysToAdd)
  return futureDate
}

const fiveDaysFromNow = getFutureDate(today, 5)
