<template>
  <section class="bg-secondary pt-5 pb-4">
    <b-container class="py-lg-2 py-xl-4 py-xxl-5">
      <b-row class="mt-1 pt-sm-2 pt-md-3 pt-lg-4">
        <b-col lg="5" class="mb-5 mb-lg-0">
          ...
          <b-form class="needs-validation row g-4">
            <b-col lg="10">
              <b-form-group label="Name" label-for="name" label-class="fs-base" :invalid-feedback="feedback">
                <b-form-input class="form-control-lg" v-model="name" trim required />
              </b-form-group>
            </b-col>
            <b-col lg="10">
              <b-form-group label-class="fs-base" label="Email" label-for="email">
                <b-form-input class="form-control-lg" type="email" placeholder="Email address" required id="email" />
              </b-form-group>
            </b-col>
            <b-col lg="10">
              <b-form-group label-class="fs-base" label="Message" label-for="message"> <b-form-textarea class="form-control-lg" placeholder="Your message" rows="4" required id="message" /></b-form-group>
            </b-col>
            <b-col lg="10">
              <b-button size="lg" variant="dark" pill class="mt-2" type="submit">Send request</b-button>
            </b-col>
          </b-form>
        </b-col>
        <b-col lg="7" xl="6" class="offset-xl-1">
          <b-row class="row-cols-1 row-cols-sm-2">
            <b-col>
              ...
              <b-card no-body class="border-0 bg-primary" data-bs-theme="dark">
                <b-card-body>
                  <svg class="d-block mb-3" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <b-col class="d-flex flex-column pt-4 mt-sm-3">
              <b-card no-body class="border-0 order-sm-2 mb-4 mb-sm-0">
                <b-card-body>
                  <svg class="d-block mb-3" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="text-warning" d="M31.5412 14.6389C30.9843 23.6874 23.7303 30.927 14.6641 31.4828V35.9999H36.0671V14.6389H31.5412Z" fill="currentColor"></path>
                    <path class="text-primary" d="M13.5469 27.0373C21.0277 27.0373 27.0922 20.9848 27.0922 13.5186H13.5469V27.0373Z" fill="currentColor"></path>
              ...
              <b-card no-body class="border-0 bg-primary order-sm-1 mb-sm-4" data-bs-theme="dark">
                <b-card-body>
                  <svg class="d-block mb-3" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
import { ref } from 'vue'
const name = ref('')
const feedback = ref('Please enter your name!')
</script>
