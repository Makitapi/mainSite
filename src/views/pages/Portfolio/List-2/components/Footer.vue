<template>
  <footer class="footer bg-secondary pt-4 pb-2 pb-md-5 pt-sm-5">
    <b-container fluid class="pb-1 pb-md-0 px-md-5">
      <div class="bg-dark rounded-5 position-relative overflow-hidden w-100 py-5 px-3 px-sm-4 px-xl-5 mx-auto" style="max-width: 1660px" data-bs-theme="dark">
        <div class="position-absolute top-50 start-50 translate-middle" style="width: 1664px">
          <img :src="footerWaveImg" alt="Wave" />
        </div>
        <b-container class="position-relative z-2 pt-md-3 pt-lg-4 pt-xl-5 pb-2">
          <b-row class="pb-2">
            <b-col lg="4" xxl="3" class="pb-2 pb-lg-0 mb-4 mb-lg-0">
              ...
              <div class="input-group input-group-sm rounded-pill">
                <b-form-input class="form-contro" type="text" placeholder="Email address" />
                <b-button rounded pill variant="primary">Subscribe</b-button>
              </div>
            </b-col>
            <b-col sm="4" lg="2" offset-lg="1" offset-xl="2" class="offset-xxl-3 mb-4 mb-sm-0">
            ...
            <b-col sm="4" lg="2" class="mb-4 mb-sm-0">
          ...
          <div class="d-sm-flex align-items-center justify-content-between pt-4 pt-md-5 mt-2 mt-md-0 mt-lg-2 mt-xl-4">
            ...
            <p class="nav fs-sm order-sm-1 text-center text-sm-start pt-4 pt-sm-0 mb-0 me-4">
              ...
              <a class="nav-link fw-normal p-0 ms-1" :href="developedByLink" target="_blank" rel="noopener">{{ developedBy }}</a>
            </p>
          </div>
        </b-container>
      </div>
...
import footerWaveImg from '@/assets/img/landing/web-studio/footer-wave.png'
