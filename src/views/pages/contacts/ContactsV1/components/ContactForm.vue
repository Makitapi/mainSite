<template>
  <b-container style="margin-top: -260px" data-bs-theme="dark">
          ...
          <b-row class="g-4">
            ...
            <b-col sm="6">
              <b-form-group label="Company">
                <b-form-input size="lg" type="text" placeholder="Your company name" required id="company" />
              </b-form-group>
            </b-col>
            <b-col sm="6">
            ...
            <b-col sm="6">
              <b-form-group label="Phone">
                <b-form-input size="lg" type="text" placeholder="Phone number" id="phone" />
              </b-form-group>
            </b-col>
            <b-col sm="12">
              <b-form-group label="How can we help?">
                <b-form-textarea size="lg" rows="6" placeholder="Enter your message here..." required id="message"></b-form-textarea>
              </b-form-group>
            </b-col>
            <b-col sm="12">
              <b-form-checkbox inline>SEO Website Audit</b-form-checkbox>
              <b-form-checkbox inline>Email Marketing</b-form-checkbox>
              <b-form-checkbox inline>Social Networks</b-form-checkbox>
              <b-form-checkbox inline>Content Marketing</b-form-checkbox>
            </b-col>
