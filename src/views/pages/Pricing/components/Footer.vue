<template>
  <footer class="footer bg-dark py-5" data-bs-theme="dark">
    <b-container class="pt-md-2 pt-lg-3 pt-xl-4">
      <b-row class="pb-5 pt-sm-2 mb-lg-2">
        <b-col md="4" lg="3" class="pb-2 pb-md-0 mb-4 mb-md-0">
          <router-link class="navbar-brand py-0 mb-3 mb-md-4" :to="{ name: 'landing' }">
      ...
      <p class="nav fs-sm mb-0">
        ...
        <a class="nav-link fw-normal p-0 ms-1" :href="developedByLink" target="_blank" rel="noopener">
          {{ developedBy }}
        </a>
      </p>
    </b-container>
