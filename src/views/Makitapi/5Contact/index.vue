...
import ContactForm from '@/views/Makitapi/5Contact/components/ContactForm.vue'
import ContactDetails from '@/views/Makitapi/5Contact/components/ContactDetails.vue'
