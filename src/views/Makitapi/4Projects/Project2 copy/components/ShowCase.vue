<template>
  <b-container class="pt-lg-2 pt-xl-4 pt-xxl-5">
      ...
      <b-col md="9" offset-lg="1">
        <div class="ps-md-4 ps-lg-0">
          <div class="border-bottom pb-3 pb-sm-4 pb-lg-5 mb-4">
            <p class="text-dark lead mb-md-2 mb-lg-3 mb-xl-4">When a major retail distribution center handling 50 million hanging garments annually decided to implement RFID portals, they expected sizeable improvements. What they discovered was a transformation journey that would more than triple their inbound processing speed—but only by completely reimagining their operations around the technology.</p>
          </div>
    ...
    <b-row class="pt-sm-3 pt-md-4 pb-5 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
      ...
      <b-col md="5" offset-xl="1">
        <b-row class="row-cols-2 gx-3 gx-sm-4">
          <b-col v-for="(stats, idx) in single2counter" :key="idx">
            <div class="h2 display-1 mb-0">{{ stats.number }}</div>
            <p class="fs-sm mb-0">{{ stats.description }}</p>
          </b-col>
        </b-row>
      </b-col>
    </b-row>
    ...
    <b-row class="pt-1 pt-sm-3 pt-md-4 pb-5 mb-md-2 mb-lg-3 mb-xl-4 mb-xxl-5">
      <b-col md="11" lg="9" xl="8" class="pb-1 pb-sm-3 pb-md-4">
        <h2 class="h1 pb-sm-2 pb-lg-3">Results</h2>
        <p class="fs-lg mb-0">This retailer's success story proves that RFID implementation isn't plug-and-play—it's a strategic journey. While immediate improvements are possible, transformational results require organizations to reshape operations around the technology's capabilities, not the reverse. The 4,900 items per man-hour achievement represents over $200k in annual labor savings, but more importantly, it demonstrates how embracing technological change as an organizational evolution—rather than just a tool upgrade—unlocks exponential value.</p>
        <b-row class="row-cols-3 pt-2 pt-sm-3 pt-md-4 pt-xl-5 my-3">
...
import parallaxImg from '@/assets/img/portfolio/single/v2/parallax.jpg'
</script>
