<template>
  <footer class="footer">
    <div class="bg-primary py-4" data-bs-theme="dark">
      <b-container class="fs-lg text-body text-center">Our dedicated team of nearly 2,300 staff members is prepared to assist you. <a class="text-white" href="#">Talk to our finance agent</a></b-container>
    </div>
    <div class="bg-secondary py-5">
      <b-container class="pt-sm-2 pt-md-3 pt-lg-4">
        <b-row class="gy-md-5 gy-4 mb-md-5 mb-4 pb-lg-2">
          <b-col lg="3">
            <router-link :to="{ name: 'landing' }" class="navbar-brand d-inline-flex align-items-center mt-0 mb-lg-4 mb-3">
            ...
            <div class="mt-n3 ms-n3 d-flex gap-1">
          ...
          <b-col xl="8" class="offset-xl-1 col-lg-9">
            <b-row class="row-cols-sm-4 row-cols-1">
              <b-col>
        ...
        <div class="fs-sm text-body-secondary">
          &copy; All rights reserved. Made by <a :href="developedByLink" target="_blank" rel="noopener" class="text-dark text-decoration-none opacity-90"> {{ developedBy }}</a>
        </div>
      </b-container>
    </div>
  </footer>
