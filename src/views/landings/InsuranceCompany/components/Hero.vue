<template>
  <section class="position-relative pt-md-2 pt-lg-4 pt-xl-5 pb-5 pb-lg-0">
    ...
    <b-container class="position-relative z-2 pt-5 pb-2 pb-sm-3 pb-lg-0">
      ...
      <div class="position-relative d-none d-md-block">
        <div class="position-absolute" style="right: 78.24%">
          <img class="position-relative z-2" :src="googleReviews" width="282" alt="Google reviews" />
      ...
      <Jarallax custom-class="jarallax rounded overflow-hidden z-2" :options="{ speed: 0.65 }" style="-webkit-clip-path: url(#shape); clip-path: url(#shape)">
        ...
        <img class="position-absolute top-0 end-0 z-2 mt-4 me-4" :src="award" width="132" alt="Award" />
        <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-25"></span>
        <div class="jarallax-img" :style="`background-image: url(${bgImage})`"></div>
      </Jarallax>

      <!-- Clients (visible on screens > 768px) -->
      <div class="position-absolute bottom-0 d-none d-md-block" style="left: 77.5%">
        <img class="position-relative z-2 d-dark-mode-none" :src="clientsLight" width="282" alt="Google reviews" />
        <img class="position-relative z-2 d-none d-dark-mode-block" :src="clientsDark" width="282" alt="Google reviews" />
        <div class="position-absolute top-0 start-0 w-100 h-100 bg-light rounded-3 shadow-sm d-dark-mode-none"></div>
        <div class="position-absolute top-0 start-0 w-100 h-100 rounded-3 d-none d-dark-mode-block" style="background-color: #202327"></div>
      </div>
...
import bgImage from '@/assets/img/landing/insurance/hero/bg-image.jpg'
import googleReviews from '@/assets/img/landing/insurance/hero/google-reviews.png'
import award from '@/assets/img/landing/insurance/hero/award.png'
import clientsLight from '@/assets/img/landing/insurance/hero/clients-light.png'
import clientsDark from '@/assets/img/landing/insurance/hero/clients-dark.png'
</script>
