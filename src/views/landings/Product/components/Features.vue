<template>
  <b-container class="pt-5">
    <div class="position-relative mt-sm-2 mb-4 mb-sm-5">
      <img class="d-block rounded-5" :src="videoCover" alt="Video cover" />
      <div class="d-nline-flex position-absolute top-50 start-50 translate-middle z-2 p-4">
        <LightGallery custom-class="gallery">
          <a class="btn btn-icon btn-xl btn-primary rounded-circle stretched-link gallery-item" href="https://www.youtube.com/watch?v=udMULpKcnn8" data-bs-toggle="video" aria-label="Play video">
            <i class="ai-play-filled"></i>
          </a>
        </LightGallery>
      </div>
    </div>
    <b-row class="row-cols-1 row-cols-sm-3 pt-2 pt-sm-0 pt-lg-3">
      <b-col class="pb-4 mb-1">
        <div style="max-width: 336px">
          <svg class="d-block mb-3 mb-lg-4" width="40" height="40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <p class="mb-0">Adipiscing posuere dui, amet, augue nisl dictum justo enim sed neque congue non quam ultrices interdum vitae vestibulum.</p>
        </div>
      </b-col>
      <b-col class="pb-4 mb-1">
        <div class="mx-sm-auto" style="max-width: 336px">
          ...
          <p class="mb-0">Dignissim eget ultrices feugiat dolor volutpat amet et suscipit metus sed laoreet platea amet, sit sem at dui tempor netus.</p>
        </div>
      </b-col>
      <b-col class="pb-4 mb-1">
        <div class="ms-sm-auto" style="max-width: 336px">
          ...
          <p class="mb-0">Tellus sit quam libero, ut quam praesent mi, elementum vulputate amet viverra purus sed velit morbi tellus sodales sed vitae.</p>
        </div>
      </b-col>
    </b-row>
  </b-container>
