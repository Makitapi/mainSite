<template>
  <section class="pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
    <b-container class="pt-2 pt-sm-4 pt-lg-5 mt-md-2">
      <b-row>
        <b-col xl="4" md="5" class="mb-5 mb-md-0" style="margin-top: -125px">
          <div class="position-sticky top-0" style="padding-top: 125px">
            ...
            <ul class="list-unstyled mb-0">
              <li class="d-flex align-items-center mb-3">
                <svg class="d-block flex-shrink-0 text-primary" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <b-col md="7" class="offset-xl-1">
          <div class="ps-md-4 ps-xxl-5">
            <PricingCard v-for="(plan, idx) in pricingPlans" :key="idx" :plan="plan" :class="{ 'mb-3': idx != pricingPlans.length - 1 }" />
          </div>
        </b-col>
      </b-row>
    </b-container>
...
import PricingCard from '@/views/landings/YogaStudio/components/PricingCard.vue'
import { pricingPlans } from '@/views/landings/YogaStudio/data'
</script>
