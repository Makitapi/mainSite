<template>
  <section class="pt-5" style="background: linear-gradient(176.14deg, #f8f7e1 2.64%, #feeae7 94.95%)">
    <b-container class="pt-5" data-bs-theme="light">
      <b-row class="align-items-center justify-content-center pt-3 pt-sm-4 mt-sm-3">
        <b-col sm="9" md="8" lg="7" class="offset-lg-1 order-md-2 pb-3 pb-sm-0 mt-md-n5 mb-4 mb-sm-5">
          <div class="ps-md-4 ps-lg-0 mt-md-n4 mt-lg-n5">
            <h1 class="display-5 mb-lg-4">Hi, I'm <span class="text-dark fw-bolder" data-bs-theme="light">Jane Cooper</span><br />Wellness &amp; lifestyle influencer</h1>
            <p class="text-body fs-lg">Workouts designed for optimal results. Start your journey to wellness with me!</p>
            <div style="max-width: 24rem">
              ...
              <div class="d-flex">
                <div class="pe-3 me-sm-3">
                  ...
                  <b-button size="lg" variant="primary" class="px-4" type="button">
                    <span class="text-light px-sm-2">{{ currency }}14.<sup>99</sup> / month</span>
                  </b-button>
                </div>
                <div>
                  <div class="d-table position-relative text-dark mt-n3 mb-2" data-bs-theme="light">
                    <h3 class="h5 fw-bold mb-0 position-absolute start-50 top-50 translate-middle">Annual</h3>
                  ...
                  <button class="btn btn-lg bg-dark px-4" type="button">
                    <span class="text-light px-sm-2">{{ currency }}89.<sup>99</sup> / year</span>
                  </button>
        ...
        <b-col cols="6" sm="5" md="4" class="order-md-1">
          <img :src="influencerHero" width="416" alt="Influencer" />
        </b-col>
      </b-row>
    </b-container>
  </section>
...
import influencerHero from '@/assets/img/landing/influencer/hero.png'
</script>
