<template>
  <footer class="footer py-5">
    <b-container class="d-flex flex-column flex-lg-row justify-content-between align-items-center pt-1 py-sm-2 py-lg-4 py-xl-5">
      ...
      <div class="nav flex-sm-nowrap justify-content-center mb-3 mb-sm-4 mb-lg-0">
        <a class="nav-link fw-normal border-end-lg px-2 px-sm-3 px-lg-4 py-1 py-sm-0 mx-1 mx-sm-0 mx-xl-2" href="#">Support</a>
        <a class="nav-link fw-normal border-end-lg px-2 px-sm-3 px-lg-4 py-1 py-sm-0 mx-1 mx-sm-0 mx-xl-2" href="#">Privacy Policy</a>
        <a class="nav-link fw-normal px-2 px-sm-3 px-lg-4 py-1 py-sm-0 mx-1 mx-sm-0 mx-xl-2" href="#">Terms &amp; Conditions</a>
      </div>
