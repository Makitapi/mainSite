<template>
  <section class="overflow-hidden pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
    <b-container class="pt-2 pt-sm-4 pt-lg-5">
      ...
      <b-row class="align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
        <b-col md="6" xl="5" class="offset-lg-1 order-md-2 pb-2 pb-md-0 mb-4 mb-md-0" data-aos="fade-left" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
          <img class="d-dark-mode-none" :src="stepImgLight1" width="525" alt="Img" />
          <img class="d-none d-dark-mode-block" :src="stepImgDark1" width="525" alt="Img" />
        </b-col>
      ...
      <b-row class="align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
        <b-col md="6" xl="5" class="offset-xl-1 pb-2 pb-md-0 mb-4 mb-md-0" data-aos="fade-right" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
          <img class="d-dark-mode-none" :src="stepImgLight2" width="473" alt="Img" />
          <img class="d-none d-dark-mode-block" :src="stepImgDark2" width="473" alt="Img" />
        </b-col>
      ...
      <b-row class="align-items-center position-relative">
        <b-col md="6" xl="5" class="offset-lg-1 order-md-2 d-md-flex justify-content-end pb-2 pb-md-0 mb-4 mb-md-0" data-aos="fade-left" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
          <img class="d-dark-mode-none" :src="stepImgLight3" width="473" alt="Img" />
          <img class="d-none d-dark-mode-block" :src="stepImgDark3" width="473" alt="Img" />
        </b-col>
        <b-col md="6" lg="5" xl="4" class="offset-xl-1 order-md-1" data-aos="fade-right" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
          <div class="pe-md-4 pe-lg-0">
...
import stepImgLight1 from '@/assets/img/landing/saas-2/steps/01-light.png'
import stepImgDark1 from '@/assets/img/landing/saas-2/steps/01-dark.png'
import stepImgLight2 from '@/assets/img/landing/saas-2/steps/02-light.png'
import stepImgDark2 from '@/assets/img/landing/saas-2/steps/02-dark.png'
import stepImgLight3 from '@/assets/img/landing/saas-2/steps/03-light.png'
import stepImgDark3 from '@/assets/img/landing/saas-2/steps/03-dark.png'
</script>
