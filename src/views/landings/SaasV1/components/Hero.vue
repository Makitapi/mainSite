<template>
  <section class="position-relative pt-5">
    <div class="position-absolute top-0 start-0 w-100" style="height: 79%">
      ...
      <div class="position-absolute start-0 bottom-0 w-100 overflow-hidden mb-n1" style="padding-bottom: 6.2%; color: var(--ar-body-bg)">
    ...
    <b-container class="position-relative z-5 pt-5 mt-4 mt-lg-5" data-bs-theme="dark">
      <b-row class="justify-content-center text-center pt-md-2 pt-lg-0 pt-xl-2 pb-5 mb-md-2">
        <b-col lg="10" xl="9" xxl="8"
          ><span class="badge bg-light bg-opacity-10 fs-sm text-white px-3 mb-4">Take your data to the next level</span>
          ...
          <router-link class="btn btn-lg btn-warning" to="#">Start free 14-day trial</router-link>
        </b-col>
      </b-row>
      <div class="bg-black rounded-4 p-2 mx-auto" style="max-width: 1160px">
        <div class="overflow-hidden" style="border-radius: calc(var(--ar-border-radius) * 1.25)">
          <ImgComparisonSlider class="m-n1">
            <!-- eslint-disable vue/no-deprecated-slot-attribute -->
            <img :src="dashboardDark" slot="first" alt="Dashboard Dark Mode" />

            <img :src="dashboardLight" slot="second" alt="Dashboard Light Mode" />

            <div style="width: 42px" slot="handle">
...
import dashboardLight from '@/assets/img/landing/saas-1/hero/dashboard-light.jpg'
import dashboardDark from '@/assets/img/landing/saas-1/hero/dashboard-dark.jpg'
</script>
