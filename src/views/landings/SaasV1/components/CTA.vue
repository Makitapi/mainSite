<template>
  <b-container class="py-5 my-lg-3 my-xl-4 my-xxl-5">
    <b-row class="align-items-center justify-content-center py-2 py-sm-3 py-md-4 my-xl-2" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
      <b-col cols="12" sm="5" md="4" class="offset-md-1 order-sm-2 pb-4 pb-sm-0 mb-2 mb-sm-0">
        <img class="d-dark-mode-none" :src="deviceImageLight" width="414" alt="Mobile screen" />
        <img class="d-none d-dark-mode-block" :src="deviceImageDark" width="414" alt="Mobile screen" />
      </b-col>
      <b-col sm="7" md="6" xl="5" class="offset-xl-1 order-sm-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
        <div class="pe-sm-3 pe-md-0">
          <h2 class="h1 pb-1 pb-sm-2 pb-lg-3">Download Around app for any devices</h2>
          <p class="mb-0">Now there is a mobile application so that you can always quickly and conveniently track your data morbi et massa fames ac scelerisque sit commodo dignissim.</p>
          <div class="d-flex justify-content-between pt-4 pt-lg-5 mt-sm-2" style="max-width: 450px">
            <div class="pe-2">
              ...
              <a class="btn btn-primary btn-lg px-3 py-2" href="#">
                <img class="mx-1" :src="appStoreLight" width="136" alt="App Store" />
              </a>
            </div>
            <div class="ps-2">
              ...
              <a class="btn btn-primary btn-lg px-3 py-2" href="#">
                <img class="mx-1" :src="googleplayLight" width="135" alt="Google Play" />
              </a>
            </div>
          </div>
        </div>
  ...
  <b-container>
    <div class="bg-dark rounded-5 position-relative overflow-hidden py-5 px-4 px-sm-5">
      ...
      <svg class="position-absolute start-0 bottom-0 z-2" width="713" height="410" viewBox="0 0 713 410" fill="none" stroke="white" stroke-opacity="0.12" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg class="position-absolute top-0 end-0 z-2" width="317" height="367" viewBox="0 0 317 367" fill="none" stroke="white" stroke-opacity="0.12" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="position-relative z-3 text-center px-3 px-sm-0 pb-2 py-sm-3 py-md-4 py-lg-5" data-bs-theme="dark">
        <h2 class="display-3 pt-xl-2">Get Started with Around</h2>
        <p class="text-body fs-lg pb-4 pb-lg-5 mb-2 mb-sm-3 mb-lg-0 mb-xl-2">Using basic data skills you can analysis and improve your business indicators.</p>
        <router-link class="btn btn-lg btn-primary mb-lg-2 mb-xl-4" to="#">Start free 14-day trial</router-link>
      </div>
    </div>
  </b-container>
</template>
...
import deviceImageLight from '@/assets/img/landing/saas-1/cta/device-light.png'
import deviceImageDark from '@/assets/img/landing/saas-1/cta/device-dark.png'
