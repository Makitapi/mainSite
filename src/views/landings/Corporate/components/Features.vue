<template>
  <section class="bg-secondary py-5">
    <b-container class="py-md-2 py-lg-4 my-xl-2 my-xxl-3">
      <b-row class="align-items-center py-3 py-sm-4 py-lg-5 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4 mb-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="md">
        <b-col md="6" xxl="5" class="offset-lg-1 offset-xl-2 offset-xxl-3 order-md-2 pb-1 pb-sm-2 pb-md-0 mb-4 mb-md-0">
          <div class="position-relative">
            <img class="d-block rounded-1" :src="feature1" alt="Img" />
        ...
        <b-col md="6" lg="5" xl="4" class="order-md-1" data-aos="fade-up" data-aos-duration="800" data-aos-offset="180" data-disable-parallax-down="md">
          <div class="pe-md-4 pe-lg-0">
            <h2 class="h1 pb-sm-2 pb-lg-3">Let's grow business together</h2>
            <p class="fs-xl pb-3 mb-1 mb-sm-2 mb-md-3 mb-lg-4">Vitae tempor morbi tellus pulvinar ut iaculis sit tristique in turpis volutpat quam nec pretium eu nulla egestas ultrices donec in pulvinar ut fermentum nun aliquam.</p>
      ...
      <b-row class="align-items-center py-3 py-sm-4 py-lg-5 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4 mb-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="md">
        <b-col md="6" xxl="5" class="offset-xl-1 offset-xxl-2 order-md-2 pb-1 pb-sm-2 pb-md-0 mb-4 mb-md-0">
          <div class="position-relative">
            <img class="d-block rounded-1 position-relative z-2" :src="feature2" alt="Img" />
        ...
        <b-col md="6" xl="5" class="order-md-1" data-aos="fade-up" data-aos-duration="800" data-aos-offset="180" data-disable-parallax-down="md">
          <div class="pe-md-4 pe-lg-0">
            <h2 class="h1 pb-3 mb-2 mb-lg-3 mb-xl-4">Our professional approach to your business</h2>
            <b-row class="row-cols-1 row-cols-sm-2 g-4">
              <b-col>
                <div class="text-body-secondary mb-2">01</div>
                <h3 class="h5">Individual approach</h3>
                <p class="mb-0">Hac erat leo proin odio est sed sit in felis facilisi integer sed congue neque turpis dictumst sitsed volutpat aliquet tortor.</p>
              </b-col>
              <b-col>
                <div class="text-body-secondary mb-2">02</div>
                <h3 class="h5">Integrated analytics</h3>
                <p class="mb-0">Find aute irure dolor in enderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur neque congue neque turpis.</p>
              </b-col>
            </b-row>
          </div>
        </b-col>
      ...
      <b-row class="align-items-center py-3 py-sm-4 py-lg-5 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="md">
        <b-col md="6" xxl="5" class="offset-lg-1 offset-xl-2 offset-xxl-3 order-md-2 pb-1 pb-sm-2 pb-md-0 mb-4 mb-md-0">
          <div class="position-relative">
            <img class="d-block rounded-1" :src="feature3" alt="Img" />
        ...
        <b-col md="6" lg="5" xl="4" class="order-md-1" data-aos="fade-up" data-aos-duration="800" data-aos-offset="180" data-disable-parallax-down="md">
          <div class="pe-md-4 pe-lg-0">
            ...
            <p class="fs-xl mb-lg-4">Find aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.</p>
...
import feature1 from '@/assets/img/landing/corporate/features/01.jpg'
import feature2 from '@/assets/img/landing/corporate/features/02.jpg'
import feature3 from '@/assets/img/landing/corporate/features/03.jpg'
</script>
