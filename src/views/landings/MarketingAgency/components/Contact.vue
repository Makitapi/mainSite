<template>
  <b-container style="margin-top: -380px" data-bs-theme="dark">
    <b-card no-body class="border-0 bg-primary position-relative py-lg-4 py-xl-5">
      <!-- Decorative shapes -->
      ...
      <b-card-body class="position-relative z-2 py-5">
        <b-form class="mx-auto" style="max-width: 800px">
          <h2 class="h1 card-title text-center pb-4">Get a free consultation</h2>
          <b-row class="g-4">
            <b-col sm="6">
              <b-form-group label="Name" label-class="fs-base">
                <b-form-input size="lg" type="text" placeholder="Your name" required id="name" />
              </b-form-group>
            </b-col>
            <b-col sm="6">
              <b-form-group label="Company" label-class="fs-base">
                <b-form-input size="lg" type="text" placeholder="Your company name" id="company" />
              </b-form-group>
            </b-col>
            <b-col sm="6">
              <b-form-group label="Email" label-class="fs-base">
                <b-form-input size="lg" type="email" placeholder="Email address" required id="email" />
              </b-form-group>
            </b-col>
            <b-col sm="6">
              <b-form-group label="Phone" label-class="fs-base">
                <b-form-input size="lg" type="tel" placeholder="Phone number" id="phone" />
              </b-form-group>
            </b-col>
            <b-col sm="12">
              <b-form-group label="How can we help?" label-class="fs-base">
                <b-form-textarea size="lg" rows="6" placeholder="Enter your message here..." required id="message" />
              </b-form-group>
            </b-col>
            <b-col sm="12">
              <b-form-group>
                <b-form-checkbox-group>
                  <b-form-checkbox value="seo">SEO Website Audit</b-form-checkbox>
                  <b-form-checkbox value="email-marketing">Email Marketing</b-form-checkbox>
                  <b-form-checkbox value="social">Social Networks</b-form-checkbox>
                  <b-form-checkbox value="content-marketing">Content Marketing</b-form-checkbox>
                </b-form-checkbox-group>
              </b-form-group>
            </b-col>
            <b-col sm="12" class="text-center pt-4">
              <b-button size="lg" variant="light" type="submit">Send a request</b-button>
            </b-col>
          </b-row>
        </b-form>
      </b-card-body>
