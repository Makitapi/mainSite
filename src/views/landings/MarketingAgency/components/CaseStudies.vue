        ...
        <div class="ps-md-4 ps-xl-0">
          ...
          >
            <SwiperSlide class="pb-1" v-for="(item, idx) in caseStudies" :key="idx" :dataSwiperBinded="`#image${idx + 1}`">
              ...
              <div class="d-sm-flex">
                <a class="btn btn-primary w-100 w-sm-auto mb-3 mb-sm-0 me-sm-3 me-xl-4" href="#">Read a full story</a>
                <a class="btn btn-outline-primary w-100 w-sm-auto d-md-none d-lg-inline-flex" href="#">All case studies</a>
              </div>
            </SwiperSlide>
          </Swiper>
        </div>
