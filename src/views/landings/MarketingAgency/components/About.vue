<template>
  <section class="overflow-hidden pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
    <b-container class="pb-sm-2 pb-md-3 pb-lg-5 mb-md-3 mb-lg-0">
      ...
      <b-row class="pt-5 mt-md-4">
        <b-col md="6" xxl="5" class="offset-xxl-1 mb-4 mb-md-0">
          <div class="text-center text-md-start pe-md-4 pe-xl-5 pe-xxl-0">
            ...
            <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0" style="max-width: 475px">Sapien ultrices egestas at faucibus on diam velit diam amet nibh in quam rutrum diam natoque scelerisque viverra pharetra quis massa maecenas vulputate.</p>
        ...
        <b-col md="6" class="mt-n3">
          <b-row class="row-cols-2 row-cols-sm-3 row-cols-md-2 row-cols-lg-3 gy-md-2 gx-3">
            <b-col v-for="(company, idx) in companyData" :key="idx" :class="companyData.length - 1 == idx && 'd-none d-sm-block d-md-none d-lg-block'">
              <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px">
                <div class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                  <img class="d-block d-dark-mode-none" :src="company.image.dark" :width="company.image.width" alt="" />
                  <img class="d-none d-dark-mode-block" :src="company.image.light" :width="company.image.width" alt="" />
                </div>
              </div>
            </b-col>
          </b-row>
...
import { companyData } from '@/views/landings/MarketingAgency/data'

import about1 from '@/assets/img/landing/marketing-agency/about/01.png'
import about2 from '@/assets/img/landing/marketing-agency/about/02.png'
</script>
