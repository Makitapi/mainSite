<template>
  <b-container>
    <b-card no-body class="border-0 bg-primary bg-opacity-10 position-relative overflow-hidden">
      ...
      <b-card-body class="position-relative z-2 px-lg-0 py-lg-5">
        <b-row class="py-2 py-sm-1 py-md-3 py-lg-4 py-xl-5">
          ...
          <b-col md="8" lg="7">
            ...
            >
              <SwiperSlide v-for="(testimonial, idx) in testimonialData" :dataSwiperBinded="`#author${idx + 1}`" :key="idx">
...
import { Controller, Pagination, EffectFade } from 'swiper/modules'
import { testimonialData } from '@/views/landings/MarketingAgency/data'
