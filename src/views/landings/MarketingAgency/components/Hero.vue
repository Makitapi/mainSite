<template>
  <section class="bg-primary bg-opacity-10 d-flex min-vh-100 overflow-hidden py-5">
    <b-container class="d-flex justify-content-center pb-sm-3 py-md-4 py-xl-5">
      <b-row class="align-items-center pt-5 mt-4 mt-xxl-0">
        <b-col lg="6" class="mb-4 mb-lg-0 pb-3 pb-lg-0">
          <Parallax custom-class="mx-auto mx-lg-0" :custom-style="{ maxWidth: '582px' }" id="parallax">
            <div class="parallax-layer z-3" data-depth="0.1">
              <div class="position-relative bg-dark mx-auto" style="max-width: 61%; padding: 0.3125rem; margin-bottom: 9.9%; border-radius: calc(var(--ar-border-radius) * 2.125)">
                <div class="position-absolute start-50 translate-middle-x" style="top: 4.4%; width: 85%">
                  <b-row class="row-cols-4 gx-2 mb-3">
                    <b-col>
                  ...
                  <div class="d-flex align-items-center">
                    <img class="rounded-circle" :src="avatar" width="35" alt="Avatar" />
            ...
            <div class="parallax-layer" data-depth="0.3">
              <img :src="shape1" alt="Background shape" />
            </div>
            <div class="parallax-layer z-2" data-depth="-0.1">
              <img :src="shape2" alt="Background shape" />
            </div>
            <div class="parallax-layer" data-depth="-0.15">
              <img :src="shape3" alt="Background shape" />
            </div>
            <div class="parallax-layer z-2" data-depth="-0.25">
              <img :src="shape4" alt="Background shape" />
            </div>
          </Parallax>
        </b-col>
        <b-col lg="6" class="text-center text-lg-start">
          <h1 class="display-2 pb-3 mb-4"><span class="fw-normal">Full services</span> marketing agency</h1>
          ...
          <div class="d-sm-flex justify-content-center justify-content-lg-start pt-5 mt-lg-2">
            <a class="btn btn-lg btn-primary w-100 w-sm-auto mb-2 mb-sm-0 me-sm-1" href="#">Get in touch</a>
...
import shape1 from '@/assets/img/landing/marketing-agency/hero/shape01.svg'
import shape2 from '@/assets/img/landing/marketing-agency/hero/shape02.svg'
import shape3 from '@/assets/img/landing/marketing-agency/hero/shape03.svg'
import shape4 from '@/assets/img/landing/marketing-agency/hero/shape04.svg'
</script>
