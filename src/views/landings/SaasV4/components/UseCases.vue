<template>
  <section class="position-relative overflow-hidden py-5">
    <span class="position-absolute top-0 start-0 w-100 h-100 d-dark-mode-none" style="background: linear-gradient(141deg, rgba(255, 255, 255, 0.01) 17.3%, #f6f9fc 78.21%)"></span>
    <div class="position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block" style="background: linear-gradient(141deg, rgba(18, 21, 25, 0) 17.3%, rgba(255, 255, 255, 0.03) 78.21%)"></div>

    <b-container class="position-relative z-2 pt-3 pt-md-4 pt-lg-5 mt-lg-2 mt-xl-4">
      <h2 class="h1 text-center pb-1 mb-2">What you can build with Around</h2>
      <p class="fs-lg text-center pb-lg-2">Well, lots of things. Some of them are listed below</p>

      <b-row class="align-items-center justify-content-center py-4 py-md-5 my-1 my-sm-3 my-md-0 my-xl-3">
        <b-col cols="11" sm="9" md="7" lg="6" class="offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
          <Parallax :custom-style="{ maxWidth: '636px' }" id="parallax1">
            ...
            <div class="parallax-layer" style="padding-right: 24.2%" data-depth="0.1">
              <img :src="lineChartLight" class="d-dark-mode-none position-relative rounded-4" style="top: 27.5%; max-width: 482px; box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.35)" alt="Total users line chart" />
              <img :src="lineChartDark" class="d-none d-dark-mode-block position-relative rounded-4" style="top: 27.5%; max-width: 482px; box-shadow: 0 12px 48px -8px rgba(0, 0, 0, 0.25)" alt="Total users line chart" />
            </div>
            <div class="parallax-layer" style="padding-left: 45.75%" data-depth="-0.12">
              <img :src="barChartLight" class="d-dark-mode-none position-relative rounded-4" style="max-width: 345px; box-shadow: 0 0 48px -4px rgba(189, 196, 221, 0.35)" alt="Traffic bar chart" />
              <img :src="barChartDark" class="d-none d-dark-mode-block position-relative rounded-4" style="max-width: 345px; box-shadow: 0 12px 48px -8px rgba(0, 0, 0, 0.35)" alt="Traffic bar chart" />
            </div>
            <div class="parallax-layer" style="padding-right: 7.547%; padding-left: 44.97%" data-depth="0.3">
              <img :src="donutChartLight" class="d-dark-mode-none position-relative rounded-4" style="top: 60.75%; max-width: 302px; box-shadow: 0 0 48px -4px rgba(189, 196, 221, 0.35)" alt="Traffic donut chart" />
              <img :src="donutChartDark" class="d-none d-dark-mode-block position-relative rounded-4" style="top: 60.75%; max-width: 302px; box-shadow: 0 -12px 48px -8px rgba(0, 0, 0, 0.35)" alt="Traffic donut chart" />
            </div>
          </Parallax>
        </b-col>
        <b-col md="5" xl="4" class="offset-xl-1 order-md-1 text-center text-md-start">
          <h3 class="h2 mb-lg-4">Data analysis tools</h3>
          <p class="fs-lg pb-lg-2 mb-4">From complex analysis to stunning visualizations, our advanced AI technology can help you extract valuable insights and make data-driven decisions faster than ever before.</p>
      ...
      <b-row class="align-items-center justify-content-center justify-content-md-start py-4 py-md-5 my-2 my-sm-3 my-md-0 my-xl-3">
        <b-col cols="11" sm="9" md="7" lg="6" class="pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
          <Parallax :custom-style="{ maxWidth: '636px' }" id="parallax2">
            ...
            <div class="parallax-layer" style="padding-right: 28.7%; padding-left: 57%" data-depth="0.3">
              <div class="position-relative">
                ...
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none" style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.35)"></span>
            ...
            <div class="parallax-layer" style="padding-right: 27.8%; padding-left: 62.9%" data-depth="0.35">
              <div class="position-relative" style="top: 30.7%">
                <div class="ratio ratio-1x1"></div>
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none" style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.45)"></span>
                <span class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block" style="background-color: #1c2126"></span>
            ...
            <div class="parallax-layer" style="padding-right: 68.2%; padding-left: 21%" data-depth="0.4">
              <div class="position-relative" style="top: 52.9%">
                <div class="ratio ratio-1x1"></div>
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none" style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, 0.4)"></span>
                <span class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block" style="background-color: #1c2126"></span>
        ...
        <b-col md="5" xl="4" class="offset-lg-1 text-center text-md-start">
      ...
      <b-row class="align-items-center justify-content-center py-4 py-md-5 my-2 my-sm-3 my-md-0 my-xl-3">
        <b-col cols="11" sm="9" md="7" lg="6" class="offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
          <Parallax :custom-style="{ maxWidth: '636px' }" id="parallax3">
            <div class="parallax-layer" data-depth="0.1">
              <img :src="windowLight" class="d-dark-mode-none rounded-4" style="box-shadow: 0 10.2px 41px -6.8px rgba(189, 196, 221, 0.3)" alt="Chat bot UI window" />
              <img :src="windowDark" class="d-none d-dark-mode-block rounded-4" style="box-shadow: 0 10.2px 41px -6.8px rgba(0, 0, 0, 0.2)" alt="Chat bot UI window" />
            </div>
            <div class="parallax-layer" data-depth="0.15">
              <img :src="message1Light" class="d-dark-mode-none" alt="Message" />
              <img :src="message1Dark" class="d-none d-dark-mode-block" alt="Message" />
            </div>
            <div class="parallax-layer" data-depth="0.25">
              <img :src="message2Light" class="d-dark-mode-none" alt="Message" />
              <img :src="message2Dark" class="d-none d-dark-mode-block" alt="Message" />
            </div>
            <div class="parallax-layer" data-depth="0.35">
              <img :src="message3Light" class="d-dark-mode-none" alt="Message" />
              <img :src="message3Dark" class="d-none d-dark-mode-block" alt="Message" />
            </div>
          </Parallax>
        </b-col>
        <b-col md="5" xl="4" class="offset-xl-1 order-md-1 text-center text-md-start">
          <h3 class="h2 mb-lg-4">Advanced chat bot</h3>
          <p class="fs-lg pb-lg-2 mb-4">Seamlessly integrate natural language processing and machine learning capabilities into your chat bot and provide a personalized experience to your end users.</p>
          <a href="#" class="btn btn-outline-primary rounded-pill">
            Learn more
            <i class="ai-arrow-right fs-lg ms-2 me-n1"></i>
          </a>
...
import lineChartLight from '@/assets/img/landing/saas-4/use-cases/data-analysis/line-chart-light.png'
import lineChartDark from '@/assets/img/landing/saas-4/use-cases/data-analysis/line-chart-dark.png'
import barChartLight from '@/assets/img/landing/saas-4/use-cases/data-analysis/bar-chart-light.png'
import barChartDark from '@/assets/img/landing/saas-4/use-cases/data-analysis/bar-chart-dark.png'
import donutChartLight from '@/assets/img/landing/saas-4/use-cases/data-analysis/donut-chart-light.png'
import donutChartDark from '@/assets/img/landing/saas-4/use-cases/data-analysis/donut-chart-dark.png'
import circle1 from '@/assets/img/landing/saas-4/use-cases/task-automation/circle-1.png'
import circle2 from '@/assets/img/landing/saas-4/use-cases/task-automation/circle-2.png'
import circle3 from '@/assets/img/landing/saas-4/use-cases/task-automation/circle-3.png'
import windowLight from '@/assets/img/landing/saas-4/use-cases/chat-bot/window-light.png'
import windowDark from '@/assets/img/landing/saas-4/use-cases/chat-bot/window-dark.png'
import message1Light from '@/assets/img/landing/saas-4/use-cases/chat-bot/message1-light.png'
import message1Dark from '@/assets/img/landing/saas-4/use-cases/chat-bot/message1-dark.png'
import message2Light from '@/assets/img/landing/saas-4/use-cases/chat-bot/message2-light.png'
import message2Dark from '@/assets/img/landing/saas-4/use-cases/chat-bot/message2-dark.png'
import message3Light from '@/assets/img/landing/saas-4/use-cases/chat-bot/message3-light.png'
import message3Dark from '@/assets/img/landing/saas-4/use-cases/chat-bot/message3-dark.png'
</script>
