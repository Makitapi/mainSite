<template>
  <section class="position-relative bg-dark pt-lg-4 pt-xl-5">
    <Jarallax custom-class="jarallax position-absolute top-0 start-0 w-100 h-100" :options="{ speed: 0.4 }">
      <div class="jarallax-img" :style="{ backgroundImage: `url(${heroBgPattern})` }"></div>
    </Jarallax>
    <b-container class="position-relative z-2 pt-2 pt-sm-4 pt-md-5">
      <b-row class="justify-content-center pt-5">
        <b-col lg="9" xl="8" class="text-center pt-5 mt-1">
          <a href="#" class="d-inline-flex align-items-center fs-sm fw-semibold text-decoration-none bg-warning bg-opacity-10 text-warning rounded-pill py-2 px-3">
            <span class="fw-semibold lh-sm">New Around v2.0</span>
            <i class="ai-arrow-right fs-lg ms-2 me-n1"></i>
          </a>
          <h1 class="display-4 text-white pt-3 mt-3 mb-4">Powerful AI models to serve your business needs</h1>
          <p class="text-white opacity-70 fs-xl">Our robust platform is designed to handle large volumes of data and processing power, making it perfect for businesses of all sizes.</p>
        </b-col>
      </b-row>
    </b-container>
...
import heroBgPattern from '@/assets/img/landing/saas-4/hero-bg-pattern.png'
