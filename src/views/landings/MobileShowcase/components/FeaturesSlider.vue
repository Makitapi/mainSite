<template>
  <b-container class="pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
    <b-row class="align-items-center pt-3 pt-sm-4 pt-lg-5 mt-md-3 mt-lg-0">
      <b-col md="6" class="pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
        <Swiper :modules="[Controller, EffectFade]" :effect="'fade'" :fadeEffect="{ crossFade: true }" @swiper="setControlledSwiper" class="binded-content bg-primary rounded-5">
          <SwiperSlide id="image1">
      ...
      <b-col md="6" xl="5" class="offset-xl-1">
        <div class="ps-md-4 ps-xl-0">
          ...
          >
            <SwiperSlide v-for="(slide, idx) in featureSlides" :key="idx" data-swiper-binded="#image1">
              <div class="text-primary fs-xl fw-bold mb-3">0{{ idx + 1 }}</div>
              <h2 class="h1 mb-lg-4">{{ slide.title }}</h2>
...
import { featureSlides } from '@/views/landings/MobileShowcase/data'

import feature1 from '@/assets/img/landing/mobile-app-showcase/features/01.png'
import feature2 from '@/assets/img/landing/mobile-app-showcase/features/02.png'
