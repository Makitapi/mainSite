<template>
  <section class="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
    ...
    <b-container class="position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
      <h1 class="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px">The Best Platform For Online Learning</h1>
      ...
      <b-row class="justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
        <b-col cols="8" lg="4" class="order-lg-2" style="margin-top: -105px">
          <div class="position-lg-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style="padding-top: 110px">
            <img class="d-block mx-auto" :src="screen02" width="322" alt="App screen" />
          </div>
        </b-col>

        <b-col sm="6" lg="4" class="order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
          <img class="d-none d-lg-block rounded-4 ms-auto" :src="screen01" width="297" alt="App screen" style="box-shadow: 0 0.9375rem 3rem -0.5rem rgba(18, 34, 50, 0.05)" />
          ...
          <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
            ...
            <p class="text-white opacity-80 mb-0">Fusce lectus neque viverra risus lobortis adipiscing integer pulvinar elementum. Lorem viverra tincidunt tortor pellentesque.</p>
          </div>
          <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px" data-aos="fade-right" data-aos-delay="200" data-aos-offset="250" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
            ...
            <p class="text-white opacity-80 mb-0">Vulputate convallis odio donec massa facilisis sed nibh rhoncus, maecenas. Maecenas morbi est neque pellentesque.</p>
          </div>
        </b-col>

        <b-col sm="6" lg="4" class="order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
          <img class="d-none d-lg-block rounded-4" :src="screen03" width="297" alt="App screen" style="box-shadow: 0 0.9375rem 3rem -0.5rem rgba(18, 34, 50, 0.05)" />
          ...
          <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px" data-aos="fade-left" data-aos-offset="250" data-aos-delay="400" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
            ...
            <p class="text-white opacity-80 mb-0">Fermentum convallis mi posuere rutrum turpis duis facilisis integer. Rhoncus in in sit tellus velit quis laoreet morbi orci sed.</p>
          </div>
          <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px" data-aos="fade-left" data-aos-offset="200" data-aos-delay="600" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
            ...
            <p class="text-white opacity-80 mb-0">Arcu nisl aliquet vel pellentesque. Vitae nibh leo, facilisis laoreet metus, felis. Egestas id enim turpis tellus, nulla adipiscing.</p>
          </div>
        </b-col>
      </b-row>
    </b-container>
...
import screen01 from '@/assets/img/landing/mobile-app-showcase/hero/screen01.png'
import screen02 from '@/assets/img/landing/mobile-app-showcase/hero/screen02.png'
import screen03 from '@/assets/img/landing/mobile-app-showcase/hero/screen03.png'
</script>
