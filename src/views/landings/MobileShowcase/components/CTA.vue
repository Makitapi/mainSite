  ...
  <section class="bg-secondary">
    <b-container>
      <div class="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
        ...
        <b-row class="align-items-center position-relative z-2">
          <b-col md="6" lg="5" xl="4" class="offset-lg-1 pb-sm-3 pt-5 py-md-0 py-lg-5" data-aos="fade-up" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="lg">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start">
              <a class="btn btn-light btn-lg px-3 py-2 me-sm-3 mb-3 mb-sm-0" href="#">
                <img class="mx-1" :src="appStoreDark" width="136" alt="App Store" />
              </a>
              <a class="btn btn-light btn-lg px-3 py-2" href="#">
                <img class="mx-1" :src="googleplayDark" width="135" alt="Google Play" />
              </a>
            </div>
          </b-col>
          <b-col md="6" lg="5" class="offset-xl-1">
            <!-- Image visible on screens < 768px -->
            <img class="d-block d-md-none mx-auto" :src="feature3" width="420" alt="App screen" />
            ...
            <div class="d-none d-md-block position-relative mx-auto" style="max-width: 484px">
              ...
              <img :src="ctaScreen" alt="App screens" data-aos="fade-left" data-aos-duration="600" data-aos-delay="200" data-aos-offset="300" data-disable-parallax-down="lg" />
            </div>
          </b-col>
        </b-row>
      </div>
...
import feature3 from '@/assets/img/landing/mobile-app-showcase/features/03.png'
...
import ctaScreen from '@/assets/img/landing/mobile-app-showcase/cta-screens.png'
</script>
