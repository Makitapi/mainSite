<template>
  <b-container class="py-5 mt-3 mb-2 my-md-4 my-lg-5">
    <b-row class="justify-content-center align-items-center py-xl-3 my-xxl-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="lg">
      <b-col lg="5" class="pb-3 pb-lg-0 mb-3 mb-sm-4 mb-lg-0" data-aos="fade-up" data-aos-duration="850" data-aos-offset="150" data-disable-parallax-down="lg">
        <div class="pe-lg-4 pe-xl-0">
          <h2 class="h1 text-center text-lg-start mb-0 mx-auto mx-lg-0" style="max-width: 468px">
            ...
            <span class="d-inline-block position-relative">
              ...
              <svg class="position-absolute top-50 end-0 translate-middle-y me-n1 mt-1" width="249" height="46" viewBox="0 0 249 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  class="text-warning"
                  opacity=".4"
      ...
      <b-col sm="10" md="8" lg="7" class="pb-2 pb-sm-1 pb-md-0">
        <Swiper
        ...
        >
          <SwiperSlide class="bg-light">
            <div class="d-flex flex-column">
              <div class="d-flex align-items-center align-self-end pb-3 mb-2 mb-md-3 mb-xl-4" style="max-width: 570px">
                <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5" style="padding: 0.375rem">
                  <img class="rounded-circle" :src="avatar44" width="80" alt="Avatar" />
                </div>
                <b-card no-body class="bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                  <b-card-body class="py-3 px-2 p-sm-4 ms-4 ms-sm-0">
              ...
              <div class="d-flex align-items-center align-self-end" style="max-width: 570px">
                <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5" style="padding: 0.375rem">
                  <img class="rounded-circle" :src="avatar46" width="80" alt="Avatar" />
                </div>
                <b-card no-body class="bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                  <b-card-body class="py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                    ...
                    <div class="h5 fw-bold mb-0">Ralph Edwards</div>
                  </b-card-body>
                </b-card>
              </div>
            </div>
          ...
          <SwiperSlide class="bg-light">
            <div class="d-flex flex-column">
              <div class="d-flex align-items-center align-self-center pb-3 mb-2 mb-md-3 mb-xl-4" style="max-width: 570px">
                <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5" style="padding: 0.375rem">
                  <img class="rounded-circle" :src="avatar47" width="80" alt="Avatar" />
                </div>
                <b-card no-body class="bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                  <b-card-body class="py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                    <p class="fs-xl">"Sit facilisis dolor arcu, fermentum vestibulum arcu elementum imperdiet. Mauris duis eleifend faucibus amet sagittis amet consequat aucibus cursus."</p>
              ...
              <div class="d-flex align-items-center align-self-end pb-3 mb-2 mb-md-3 mb-xl-4" style="max-width: 570px">
                <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5" style="padding: 0.375rem">
                  <img class="rounded-circle" :src="avatar48" width="80" alt="Avatar" />
                </div>
                <b-card no-body class="bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                  <b-card-body class="py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                    <p class="fs-xl">"Morbi ut aliquam etiam luctus feugiat ultrices. Amet pellentesque sagittis, consequat id egestas tristique turpis. Arcu odio ultricies blandit eu neque."</p>
              ...
              <div class="d-flex align-items-center align-self-center" style="max-width: 570px">
                <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5" style="padding: 0.375rem">
                  <img class="rounded-circle" :src="avatar49" width="80" alt="Avatar" />
                </div>
                <b-card no-body class="bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                  <b-card-body class="py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                    <p class="fs-xl">"Netus vel, amet placerat eget sit eleifend. Urna laoreet ultricies orci feugiat amet egestas semper praesent. Risus ut porttitor metus tortor quis eleifend."</p>
