<template>
  <section class="bg-secondary py-5">
    <b-container class="text-center pt-5 mt-lg-4 mt-xl-5">
      <div class="position-relative mx-auto my-3" style="max-width: 850px">
        <h1 class="display-3 position-relative z-2 mb-0">Task management assistant you gonna love</h1>
      ...
      <p class="fs-lg pb-3 mb-2 mb-sm-3 mb-lg-4 mx-auto" style="max-width: 640px">We offer you a new generation of task and project management system. Plan, manage and track all your tasks in one flexible software!</p>
      <a class="btn btn-lg btn-primary" href="#">Get early access</a>
    </b-container>
    <b-container fluid class="overflow-hidden px-4 pt-3 pt-sm-4 pb-sm-2 pb-md-3 py-lg-4 py-xl-5 mt-4">
      <Parallax custom-class="mx-auto" :custom-style="{ maxWidth: '1440px' }" id="parallax">
        <div class="parallax-layer" data-depth="0.1">
          <img class="d-dark-mode-none" :src="hero1Light" alt="Layer" />
          <img class="d-none d-dark-mode-block" :src="hero1Dark" alt="Layer" />
        </div>
        <div class="parallax-layer z-2" data-depth="0.25">
          <img class="d-dark-mode-none" :src="hero2Light" alt="Layer" />
          <img class="d-none d-dark-mode-block" :src="hero2Dark" alt="Layer" />
        </div>
        <div class="parallax-layer z-1" data-depth="0.35">
          <img class="d-dark-mode-none" :src="hero3Light" alt="Layer" />
          <img class="d-none d-dark-mode-block" :src="hero3Dark" alt="Layer" />
        </div>
        <div class="parallax-layer z-1" data-depth="0.45">
          <img class="d-dark-mode-none" :src="hero4Light" alt="Layer" />
          <img class="d-none d-dark-mode-block" :src="hero4Dark" alt="Layer" />
        </div>
      </Parallax>
    </b-container>
  </section>
...
import hero1Light from '@/assets/img/landing/saas-3/hero/01-light.png'
import hero1Dark from '@/assets/img/landing/saas-3/hero/01-dark.png'
import hero2Light from '@/assets/img/landing/saas-3/hero/02-light.png'
import hero2Dark from '@/assets/img/landing/saas-3/hero/02-dark.png'
import hero3Light from '@/assets/img/landing/saas-3/hero/03-light.png'
import hero3Dark from '@/assets/img/landing/saas-3/hero/03-dark.png'
import hero4Light from '@/assets/img/landing/saas-3/hero/04-light.png'
import hero4Dark from '@/assets/img/landing/saas-3/hero/04-dark.png'
</script>
