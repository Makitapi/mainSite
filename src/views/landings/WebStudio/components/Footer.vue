          ...
          <b-row class="pb-2">
            <b-col lg="4" xxl="3" class="pb-2 pb-lg-0 mb-4 mb-lg-0">
              ...
              <div class="input-group input-group-sm rounded-pill">
                <b-form-input type="text" placeholder="Email address" />
                <b-button variant="primary" pill type="button">Subscribe</b-button>
              </div>
            </b-col>
            <b-col sm="4" lg="2" class="offset-lg-1 offset-xl-2 offset-xxl-3 mb-4 mb-sm-0">
...
import footerWave from '@/assets/img/landing/web-studio/footer-wave.png'
</script>
