  ...
  <footer class="footer bg-dark py-5" data-bs-theme="dark">
    <b-container class="pt-md-2 pt-lg-3 pt-xl-4">
      <b-row class="pb-5 pt-sm-2 mb-lg-2">
        <b-col sm="5" md="4" xl="3" class="pb-2 pb-sm-0 mb-4 mb-sm-0">
          <router-link :to="{ name: 'landing' }" class="navbar-brand py-0 mb-3 mb-md-4">
        ...
        <b-col sm="6" class="offset-sm-1 offset-md-2 offset-xl-3">
