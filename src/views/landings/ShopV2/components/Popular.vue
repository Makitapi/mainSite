<template>
  <b-container class="pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
    <h2 class="h1 text-md-center pb-2 pb-sm-3 pb-lg-4">Most popular collection</h2>
    <b-row class="pb-2 pb-sm-3 pb-md-4 pb-xl-5 mb-lg-2">
      <b-col sm="7" md="5" lg="6" class="mb-4 mb-md-0">
        <div class="h-100 bg-size-cover bg-position-center rounded-5 me-md-4 me-xl-5" :style="{ backgroundImage: `url(${previewImg})` }">
          <div class="ratio ratio-16x9"></div>
        </div>
      </b-col>
      <b-col md="7" lg="6" class="py-md-4">
        <div class="py-xl-2">
          <h3>La Vie En Rose</h3>
          <p>These iconic French inspired flavours will delight your senses!<br />Assorted box of 15 macarons composed of:</p>
          <b-row class="row-cols-1 row-cols-sm-2 mb-4">
            <ul class="col d-flex flex-column list-unstyled m-0 gap-2 mb-2 mb-sm-0">
              <li class="d-flex align-items-center gap-2">
                3
                <div class="text-nowrap">
                  <img :src="popular1" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular1" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular1" :width="15" alt="Macaron" />
                </div>
                Salted caramel
              </li>
              <li class="d-flex align-items-center gap-2">
                2
                <div class="text-nowrap">
                  <img :src="popular2" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular2" :width="15" alt="Macaron" />
                </div>
                Caramel Salé
              </li>
              <li class="d-flex align-items-center gap-2">
                2
                <div class="text-nowrap">
                  <img :src="popular3" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular3" :width="15" alt="Macaron" />
                </div>
                Simplement Chocolat
              </li>
            </ul>
            <ul class="col d-flex flex-column list-unstyled m-0 gap-2">
              <li class="d-flex align-items-center gap-2">
                3
                <div class="text-nowrap">
                  <img :src="popular4" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular4" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular4" :width="15" alt="Macaron" />
                </div>
                Follement Framboise
              </li>
              <li class="d-flex align-items-center gap-2">
                3
                <div class="text-nowrap">
                  <img :src="popular5" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular5" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular5" :width="15" alt="Macaron" />
                </div>
              ...
              <li class="d-flex align-items-center gap-2">
                2
                <div class="text-nowrap">
                  <img :src="popular6" class="me-1" :width="15" alt="Macaron" />
                  <img :src="popular6" :width="15" alt="Macaron" />
                </div>
                Bleuets-Cassis
              </li>
            </ul>
          ...
          <div class="d-flex gap-4 mb-4">
            <div>
              <svg class="d-block text-body mx-auto" xmlns="http://www.w3.org/2000/svg" width="28" height="27" fill="currentColor">
                <path
...
import previewImg from '@/assets/img/landing/shop-2/popular/preview.jpg'
import popular1 from '@/assets/img/landing/shop-2/popular/th01.png'
import popular2 from '@/assets/img/landing/shop-2/popular/th02.png'
import popular3 from '@/assets/img/landing/shop-2/popular/th03.png'
import popular4 from '@/assets/img/landing/shop-2/popular/th04.png'
import popular5 from '@/assets/img/landing/shop-2/popular/th05.png'
import popular6 from '@/assets/img/landing/shop-2/popular/th06.png'
</script>
