<template>
  <section class="bg-primary py-5" data-bs-theme="dark">
    <b-container class="pt-lg-2 pt-xl-4 pt-xxl-5 pb-1 pb-sm-3">
      <b-row class="pt-sm-3 pt-md-4">
        <b-col md="6" xl="5" class="offset-xl-1">
          <h2 class="display-3">Ready to take your business to the next level?</h2>
        </b-col>
        <b-col md="6" lg="5" xl="4" class="offset-lg-1">
          ...
          <div class="input-group">
            ...
            <b-button variant="warning" type="button">Book a call</b-button>
          </div>
        </b-col>
      </b-row>
