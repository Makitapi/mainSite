...
import type { CartType, ProductType, ShoppingState, WishlistType } from '@/types/shop'
import { calculateDiscount } from '@/helpers/product'
import { cartItems } from '@/assets/cart-items'
...
export const useShoppingStore = defineStore('context_store', () => {
  const state = useLocalStorage<ShoppingState>('__AROUND_VUE__', INIT_STATE)
