const getTitle = (title: string) => {
  return title ? `${title} | Around Vue - Multipurpose Bootstrap Template` : 'Around Vue | Multipurpose Bootstrap Template'
}
...
const pagesRoutes = [
  ...
  {
    path: '/portfolio/single-1',
    name: 'portfolio.single-1',
    meta: {
      title: getTitle('Single Project v.1')
    },
    component: () => import('@/views/pages/Portfolio/Single-1/index.vue')
  },
  {
    path: '/portfolio/single-2',
    name: 'portfolio.single-2',
    meta: {
      title: getTitle('Single Project v.2')
    },
    component: () => import('@/views/pages/Portfolio/Single-2/index.vue')
  },
  {
    path: '/shop/catalog',
    name: 'shop.catalog',
  ...
  },
  {
    ...
    component: () => import('@/views/pages/Blog/SingleV1/index.vue')
  },
  {
    path: '/blog/post-2',
    name: 'blog.post-2',
    meta: {
      title: getTitle('Single Post v.2')
    },
    component: () => import('@/views/pages/Blog/SingleV2/index.vue')
  },
  {
    path: '/blog/post-3',
    name: 'blog.post-3',
    meta: {
      title: getTitle('Single Post v.3')
    },
    component: () => import('@/views/pages/Blog/SingleV3/index.vue')
  }
]
...
export const allRoutes = [...landingRoutes, ...otherRoutes, ...accountRoutes]
